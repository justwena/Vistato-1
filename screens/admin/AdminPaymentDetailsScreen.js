  ...
  const handleSaveGcashDetails = async () => {
    ...
    try {
      ...
      if (currentUser) {
        ...
        const isNumberEdited = gcashAccountNumber !== originalGcashAccountNumber;
      ...
      Alert.alert('Error', 'Failed to save GCash details. Please try again.', [{ text: 'OK', onPress: () => navigation.goBack() }]);
    } finally {
        ...
        >
          <ScrollView style={styles.paymentDetailsContainer}>
            <PaymentDetailsForm
              ...
              headingImageSource={require("../../assets/gcash-logo.png")} // Specify GCash image source
            />
          </ScrollView>
        </KeyboardAvoidingView>
      )}
